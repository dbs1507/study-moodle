...
echo "<br>";
echo "<p>Na pagina de login, clique em 'Esqueceu sua senha?'. Na próxima página, leia as orientações e escolha se quer redefinir pelo nome de usuário ou o email usado na plataforma. Se o email ou o nome de usuário estiver correto, um email será enviado a você. O email enviado contém as instruções para confirmar e completar a alteração de senha. O link enviado possui validade de 30 minutos para o acesso, caso o tempo se exeda, deve-se repetir o processo do início.</p>";
