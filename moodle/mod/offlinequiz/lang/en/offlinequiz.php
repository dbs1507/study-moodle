...
$string['formforeachstudent'] = 'Generate one form per student';
$string['formforeachstudentdesc'] = 'Generate one form per student, pre filled with their firstname, lastname and idnumber (according to configured field)';
...
$string['profile_field_serie'] = 'Série';
$string['profile_field_turma'] = 'Turma';
